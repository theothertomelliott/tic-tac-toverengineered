...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TicTacToe.GridAllOf();
  });
  ...
  describe('GridAllOf', function() {
    it('should create an instance of GridAllOf', function() {
      // uncomment below and update the code to test GridAllOf
      //var instance = new TicTacToe.GridAllOf();
      //expect(instance).to.be.a(TicTacToe.GridAllOf);
    });
