...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TicTacToe.MatchPairAllOf();
  });
  ...
  describe('MatchPairAllOf', function() {
    it('should create an instance of MatchPairAllOf', function() {
      // uncomment below and update the code to test MatchPairAllOf
      //var instance = new TicTacToe.MatchPairAllOf();
      //expect(instance).to.be.a(TicTacToe.MatchPairAllOf);
    });
