module github.com/theothertomelliott/tic-tac-toverengineered

go 1.18

require (
	github.com/deepmap/oapi-codegen v1.7.0
	github.com/fullstorydev/grpcui v1.1.1-0.20210111151256-2e37f255eaec
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/labstack/echo/otelecho v0.36.4 // indirect
